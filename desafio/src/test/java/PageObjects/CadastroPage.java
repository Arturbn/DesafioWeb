...
public class CadastroPage {
	...
	public WebElement getForm() {
		return wait.visibilityOfElement(By.xpath("//*[@id=\"__next\"]/div/div[2]/div/div[2]/form"));
	}
	...
	public WebElement getCriarContaComSaldoButton() {
		return wait.visibilityOfElement(By.xpath("//*[@id=\"__next\"]/div/div[2]/div/div[2]/form/div[6]/label"));
	}
	...
	public WebElement getTextoContaCriada() {
		return wait.visibilityOfElement(By.xpath("//*[@id=\"modalText\"]"));
	}

	public WebElement getFecharModalButton() {
		return wait.visibilityOfElement(By.xpath("//*[@id=\"btnCloseModal\"]"));
	}
}
